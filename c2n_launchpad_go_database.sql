...
(
  ...
  default charset = utf8mb4 comment 'NFT移仓订单表';
...
(
  ...
  default charset = utf8mb4 comment '产品合约表';
...
(
  ...
  default charset = utf8mb4 comment '优惠码表';
...
(
  ...
  default charset = utf8mb4 comment '售卖token记录表';
...
(
  ...
  default charset = utf8mb4 comment '推特任务表';
...
(
  ...
  default charset = utf8mb4 comment 'tg用户信息表';
...
(
  ...
  default charset = utf8mb4 comment '用户注册项目表';
...
(
  ...
  default charset = utf8mb4 comment 'Voucher表';
...
(
  ...
  default charset = utf8mb4 comment '质押记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 comment 'MetaDerby白名单';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 comment 'MetaDerby用户表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='平台用户信息表';
